...
import TopMiniNav from "~/components/home/TopMiniNav.vue";
...
<template>
  <header class="hero-wrap" id="home">
    ...
    <a class="site-logo site-logo--hero" href="#home" aria-label="Patamu home">
