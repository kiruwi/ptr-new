...
- `NUXT_PUBLIC_GA_ID` enables Google Analytics when set to a valid `G-XXXXXXXXXX` measurement ID.
...
6. Set `NUXT_PUBLIC_GA_ID` only if analytics should run in production.
